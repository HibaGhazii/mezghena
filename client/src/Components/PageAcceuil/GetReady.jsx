...
const GetReady = () => {
  ...
  return (
    <div className='mx-14 lg:mx-44 '>
      ...
      <div className='transform -translate-y-[30px] md:-translate-y-[30px] lg:-translate-y-[40px] bg-first-color w-full md:rounded-3xl h-auto text-white rounded-[20px]'>
        ...
        <ul className='sm:flex sm:flex-col md:flex md:flex-row'>
          ...
          {skills.map((skill, index) => (
            <li key={index} className='flex flex-row p-5 sm:p-5 md:p-6'>
