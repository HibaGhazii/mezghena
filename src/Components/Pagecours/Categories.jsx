...
const Categories = () => {
  ...
  return (
    <div className='flex flex-row items-center relative'>
      <div
        className='absolute left-0 md:left-20 top-1/2 transform -translate-y-1/2 cursor-pointer'
        onClick={prevSlide}
      >
      ...
      <div
        className='absolute right-0 md:right-20 top-1/2 transform -translate-y-1/2 cursor-pointer'
        onClick={nextSlide}
      >
