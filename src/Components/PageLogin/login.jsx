...
const Login = () => {
  return (
    <div className='md:flex md:bg-bg-toggle'>
        <div className='md:w-1/2 md:flex hidden'>
            <img src="/img/login.svg" className='w-full h-[610px]'/>
        </div>
        <div className="mx-5 md:bg-[url('../public/img/bgWhite.svg')] md:bg-cover md:w-[55%] md:absolute md:-right-5 md:pl-28">
            <div className='text-center'>
                <p className="mt-24 md:mt-8 text-4xl font-bold text-bg-toggle font-Jost">Welcome back</p>
            ...
            <p className='text-96A0AD mb-[40px] mt-[26px] md:mt-1 md:mb-0 text-center'>or</p>
            ...
            <div className='flex flex-col items-center text-center pt-8 px-2 md:pt-4 '> 
                <p className='text-sm md:text-xs'>Don't have an account yet? <Link to='/signup'  className='text-first-color' onClick={() => window.location.href = '/signupstudent'} >Sign up</Link> now to join our community</p>
                <img src="/img/mezghena-logo.svg" className='w-[115px] h-[120px] md:h-20 mt-[31px] md:my-2' />
            </div>
        </div>
