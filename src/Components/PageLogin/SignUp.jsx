...
const SignUp = () => {
  return (
    <div className='md:flex md:bg-bg-toggle md:h-[800px]'> 
        <div className='md:w-1/2 md:ml-20 mt-16 md:flex hidden'> 
            <img src="/img/register.svg" className='w-[500px] h-[570px]'/>
        </div>
        <div className="mx-5 md:bg-[url('../public/img/bgWhite.svg')] md:bg-cover md:w-[55%] md:absolute md:-right-5 md:pl-28">
            <div className='text-center'>
                <p className="mt-8 md:mt-4 text-4xl font-bold text-bg-toggle">Sign Up</p>
                <p className='text-96A0AD mb-5 mt-2 mx-16 md:mx-40 md:text-sm'>We've missed you! Please sign in to catch up on what you've missed</p>
            </div>
            ...
            <p className='text-96A0AD my-4 md:mt-2 md:mb-0 text-center'>or</p>
            ...
            <div className='flex flex-col items-center text-center pt-4 md:pt-2'> 
                <p className='text-sm md:text-xs'>Already have an account ? <Link to='/login' onClick={(e)=>{}} className='text-first-color'>Log In</Link></p>
                <img src="/img/mezghena-logo.svg" className='w-20 h-24 md:h-20 md:my-2' />
            </div>
        </div>
