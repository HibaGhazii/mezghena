...
const HeroSection = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row pt-28 bg-[url('../public/img/Hero-Section.png')] py-14 md:py-28 lg:py-32 rounded-b-[60px] bg-cover">
      ...
      <div className=" text-left px-12 md:block md:w-1/2 md:p-4">
      ...
      <div className="flex flex-row justify-between pt-10 md:w-1/2 md:relative">
        <div className=''>
          ...
          <div className='hidden md:absolute md:top-0 md:left-0 md:right-0 md:flex md:mx-4 lg:flex lg:mx-20'>
        ...
        <div className='text-white bg-second-color rounded-l-3xl my-6 px-4 p-5 md:absolute md:rounded-2xl md:top-40 md:left-28 md:pt-2 md:pb-1 md:mx-8 lg:mx-28'>
